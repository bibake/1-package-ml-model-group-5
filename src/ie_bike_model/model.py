...
def train_and_persist(model_path=None, filename=None, random_state=42):
    """
...
def predict(parameters, model_path=None, filename=None, random_state=42):
    ...
    try:
        ...
        if list(df.columns) != ['date', 'weathersit', 'temperature_C', 'feeling_temperature_C', 'humidity', 'windspeed']:
            print("ERROR_1.1: ensure that parameter argument receives dictionary with key in the following order: \n\
        ...
        print("ERROR_1.2: ensure that parameter argument receives dictionary with key in the following order: \n\
        ['date', 'weathersit', 'temperature_C', 'feeling_temperature_C', 'humidity', 'windspeed']")
        break
